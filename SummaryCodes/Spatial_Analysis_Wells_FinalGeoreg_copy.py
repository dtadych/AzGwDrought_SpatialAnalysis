...
# %% Exporting csv
# recoverytime.to_csv(outputpath+'Stats/Water_CAT/'+Name+'.csv')
# recoverytime.to_csv(outputpath+'Stats/Regulation/'+Name+'.csv')
...
# %%
recoverytime.loc[1996,'CAP'] = 'No recovery'
recoverytime
