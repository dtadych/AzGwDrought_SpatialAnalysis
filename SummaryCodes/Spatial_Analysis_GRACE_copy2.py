...
ax[0].plot(cm_df_year, color='black', label='Arizona Average', lw = 2)
ax[1].plot(ds['Regulated with CAP'], "+-", label='Regulated with CAP', color=c_2) 
# ax[1].plot(ds['Regulated without CAP'], "+-", label='Regulated without CAP', color=c_3) 
ax[1].plot(ds['Lower Colorado River - SW Dominated'], color=c_4, label='Lower Colorado River - SW Dominated')
ax[1].plot(ds['Upper Colorado River - Mixed'], color=c_5, label='Upper Colorado River - Mixed')
ax[1].plot(ds['Norh - Mixed'], color=c_10, label='North - Mixed')
...
ax[1].plot(ds['Northeast - GW Dominated'], color=c_9, label='Northeast - GW Dominated')
ax[1].plot(ds['South central - GW Dominated'], color=c_8, label='South central - GW Dominated')
ax[1].plot(ds['Southeast - GW Dominated'], color=c_6, label='Southeast - GW Dominated')
...
ax[0].legend(loc = [1.05, 0.4], fontsize = fsize)
ax[1].legend(loc = [1.05, 0.2], fontsize = fsize)
# 
fig.set_dpi(600)
