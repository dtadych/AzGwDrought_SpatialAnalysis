...
GWSI_folder = 'Data_Tables' #GWSI folder name
file_name = 'GWSI_WELL_COMPLETIONS.xlsx'
...
wl_data=wl_data.rename(columns={"WLCO_COMPLETION_DATE": "date",
                   "WLCO_SITE_WELL_SITE_ID": "wellid"}, errors="raise")
# %%
...
summary_join.to_csv('Well_Data_Summary_Dates.csv', na_rep='Nan')
