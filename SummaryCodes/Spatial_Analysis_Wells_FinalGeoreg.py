...
#%%
georeg['GEOREGI_NU'].astype('int64')
georeg.info()
#%%
...
reg_list = static_geo[['Combo_ID', 'GEO_Region', 'GEOREGI_NU']]
reg_list
...
#%%
cat_wl2 = pd.to_datetime(cat_wl2.index)
cat_wl2.head()
# %% 
...
wdc1.to_csv('../MergedData/Output_files/Final_Welldepth1000plus.csv')
wdc2.to_csv('../MergedData/Output_files/Final_Welldepth200to1000.csv')
wdc3.to_csv('../MergedData/Output_files/Final_Welldepth200minus.csv')

# %%
filename = 'Final_WellDepth.csv'
filepath = os.path.join(outputpath, filename)
print(filepath)
